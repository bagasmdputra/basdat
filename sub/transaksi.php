...
<body>
   ...
   <section id="page-title">	
		...
		<div class="row">
			...
			<div class="twelve columns">
				...
				<h1>Daftar transaksi<span>.</span></h1>
   ...
   <section id="content">
        <div class="row">
            <div class="tab">
                  <button class="tablinks" id="defaultOpen" onclick="openCity(event, 'London')">Pulsa</button>
                  <button class="tablinks" onclick="openCity(event, 'Paris')">Barang</button>
            </div>
