...
<body>
   	...
   	<div class="row header-inner">
	      ...
	      <nav id="nav-wrap">         
	         ...
	         <ul id="nav" class="nav">
	            ...
	            <li><a href="../indexuser.html#journal">Transaksi.  </a></li>	
   ...
   <section id="page-title">	
		...
		<div class="row">
			...
			<div class="twelve columns">
				...
				<h1>Form pilih toko<span>.</span></h1>
   ...
   <section id="content">
        <div class="row">
                  ...
                  <h3>Pilih toko yang Anda mau</h3>
            <h4>Nama Toko</h4>
                <select class="center fullwidht" id="selectList">
                   <option value="Option 1">Toko Garuda Bakti tujuh</option>
                    <option value="Option 2">Option 2</option>
                    <option value="Option 3">Option 3</option>
                    <option value="Option 4">Option 4</option>
                </select>
                
                 <p class="center"><a class="button primary full-width" href="./barang.html">PILIH TOKO</a></p>
