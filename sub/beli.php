   ...
   <section id="content">
        <div class="row">
            ...
            <fieldset>
                ...
                <label for="regularInput">berat total :</label>
				<input type="text" id="regularInput">
                <label for="regularInput">jumlah barang :</label>
				<input type="text" id="regularInput">
                 
            </fieldset>
             <p class="center"><a class="button primary full-width" href="./keranjang.html">SUBMIT</a></p>
