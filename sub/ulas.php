   ...
   <section id="contact">
   	...
   	<div class="row section-head">
   		...
   		<div class="twelve columns">
	         ...
	         <h1>Ulasan untuk pemesanan pulsa<span>.</span></h1>
            ...
            <form name="contactForm" id="contactForm" method="post" action="">
                  ...
                  <div class="row">
	                  ...
	                  <div class="six columns mob-whole">
	                  	<label for="contactFname">Nama <span class="required">*</span></label>	      						   
	      					<input name="contactFname" type="text" id="contactFname" placeholder="Nama" value="" />	      					
	                  </div>
                  ...
                  <div class="row">
	                  ...
	                  <div class="twelve columns">
	                     <label  for="contactMessage">Komentar <span class="required">*</span></label>
	                     <textarea name="contactMessage"  id="contactMessage" placeholder="Komentar" rows="10" cols="50" ></textarea>
	                  </div>
