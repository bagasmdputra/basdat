...
<body>
   ...
   <section id="page-title">	
		...
		<div class="row">
			...
			<div class="twelve columns">
				...
				<h1>Form Membeli produk pulsa   <span>.</span></h1>
   ...
   <section id="content">
        <div class="row">
            ...
            <h3>Kode produk : V000001</h3>
            <h3>Nomor HP/ Token Listrik : 150223562365315</h3>

                
                <p><br></p>
 <p class="center"><a class="button primary full-width" href="../indexuser.html">SUBMIT</a></p>
