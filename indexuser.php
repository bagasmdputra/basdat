                ...
                <h1 ><img src="images/logo.png" alt="" width="220px"></h1>
					   ...
					   <li>
						   <div class="flex-caption">
								...
								<p><a class="button stroke smoothscroll" href="#about">Mulai Petualanganmu!</a></p>
							</div>
					   </li>					              
   ...
   <section id="about">
   	...
   	<div class="row section-head">
   		...
   		<div class="twelve columns">
	         ...
	         <h1>Kami menyediakan produk berkualitas<span>.</span></h1>

	         <hr />

	         <p>Anda bisa membeli barang apapun yang Anda mau bahkan bisa membeli pulsa langsung dari TokoKeren ini.
	         </p>
   ...
   <section id="journal">
	   ...
	   <div class="row section-head">
           ...
           <div class="flex-caption">
			   ...
			   <p> Tingkatkan terus transaksi Anda untuk mendapat banyak keuntungan.
		      </p>	         
